...
def test_count_news(client, all_news_list, home_url):
    """На главную страницу выпускается 0 новостей"""
    test_count_news.__doc__ = test_count_news.__doc__.format(
...
def test_comment_sorted(client, news_comments, news, detail_url):
